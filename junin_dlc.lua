...
local function getfile(name)
    local repo = "https://raw.githubusercontent.com/crismonrp-cyber/junin-hub/main/"
...
do
    ...
    "JuNiN DLC premium | Jul 28 2024 | fps: 63 ";
    ...
    cheat.utility.new_renderstepped(LPH_JIT_MAX(function(delta)
        ...
        watertext = ("JuNiN DLC %s | %s | %s | %s fps"):format(SWG_Version, SWG_ShortName, os.date("%b %d %Y"), tostring(finalfps));
